...
<head>
    ...
    <style>
        :root{
            --bg: #0f172a;            /* slate-900 */
            --panel:#0b1026;          /* deep */
            --muted:#9fb0cd;          /* text muted */
            --text:#e6eefc;           /* text main */
        ...
        .badge-ping{
            ...
            color:#fff; border-radius:999px; padding:.25rem .5rem; font-size:.75rem; box-shadow: var(--shadow);
        }
        ...
        .btn-icon{
            ...
            padding:0;border:1px solid rgba(255,255,255,.18); background: rgba(255,255,255,.06);
        }
        ...
        .select2-container--default .select2-selection--multiple .select2-selection__choice{
            background: rgba(79,70,229,.25); border:1px solid rgba(79,70,229,.35);
        ...
        .modal-solid .custom-select,
        .modal-solid textarea{
            background: #0d1330 !important;
            border: 1px solid rgba(226,232,240,.2);
            color: var(--text);
        }
        .modal-solid .form-control:focus,
        .modal-solid .custom-select:focus,
        .modal-solid textarea:focus{
            background: #101740 !important;
            border-color: rgba(79,70,229,.55);
            box-shadow: 0 0 0 .2rem rgba(79,70,229,.25);
            color: var(--text);
        }
        .modal-solid .select2-container--default .select2-selection--multiple{
            background: #0d1330 !important;
            border: 1px solid rgba(226,232,240,.2);
            min-height: 38px;
        }
        .modal-solid .select2-dropdown{
            background: #0d1330 !important;
            color:#fff;
            border:1px solid var(--border);
        }
        ...
        .data-card .data-scroll{
            overflow: auto;
            flex: 1 1 auto;
        }
        .data-card .data-scroll thead th{
            position: sticky;
            top: 0;
            z-index: 2;
            background: rgba(79,70,229,.12);
