            ...
            <div class="list-item d-flex align-items-center">
              ...
              <div class="flex-fill">
                ...
                <small>
                  ...
                  - {{ \App\Helpers\TimeHelper::short($rapat_terdekat->waktu_mulai) }} WIT - {{ $rapat_terdekat->tempat }}
                </small>
              </div>
            ...
            <div class="list-item d-flex align-items-center">
              ...
              <div class="flex-fill">
                ...
                <small>
                  ...
                  - {{ \App\Helpers\TimeHelper::short($r->waktu_mulai) }} WIT - {{ $r->tempat }}
                </small>
              </div>
          ...
          @forelse($rapat_akan_datang as $r)
            <div class="m-card">
              ...
              <div class="m-meta mt-1">
                <span class="mchip info">{{ \Carbon\Carbon::parse($r->tanggal)->format('d/m/Y') }} - {{ \App\Helpers\TimeHelper::short($r->waktu_mulai) }}</span>
