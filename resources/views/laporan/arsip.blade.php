...
<style>
  ...
  .btn-icon{
    ...
    border:1px solid rgba(255,255,255,.18); color:#fff; transition:.15s; padding:0;
  ...
  th.col-tanggal    { width: 140px; }
  th.col-namafile   { width: 240px; }
  th.col-aksi       { width: 190px; }

  td.col-judul      { width: 34%; }
  td.col-kategori   { width: 260px; }
  td.col-rapat      { width: 260px; }
  td.col-tanggal    { width: 140px; }
  td.col-namafile   { width: 240px; }
  td.col-aksi       { width: 190px; }
        ...
        <table class="table table-sm mb-0 no-hover">
          ...
          @forelse ($uploads as $i => $u)
            <tr>
              ...
              <td class="col-kategori">{{ $u->nama_kategori ?? '-' }}</td>
